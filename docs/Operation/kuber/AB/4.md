...
kubectl -n kube-system get events -c <container-name> #container logs
```
...
If we want to have history from our updates we should use key "**kubernetes.io/change-cause **" from **annotations**
